  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center text-white">
      ...
      <div className="relative z-10 text-center p-4 flex flex-col items-center">
        <h1 className="font-headline text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter" style={{color: '#FAEBD7'}}>
          ALLY
        </h1>
        <p className="mt-4 max-w-2xl text-lg md:text-xl text-pale-blush/90" style={{color: '#FAEBD7'}}>
          Your Personal Museum Guide
        </p>
        <p className="mt-2 max-w-2xl text-base md:text-lg text-pale-blush/80" style={{color: '#FAEBD7'}}>
          Identify artworks, get personalized tours, and explore museums like never before.
        </p>
